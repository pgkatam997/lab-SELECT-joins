...
insert into skill3(id,description,name)values(1,'self learning','learn');
insert into skill3(id,description,name)values(2,'technical skills','coding');
select * from skill3;
...
insert into user_new(id,emailid,name,password,phonenumber,profile_id,role_id,username)
...
insert into querytable(id,content,dateof,parent_id,user_id)values(2,'Library management',To_DATE('2008/11/19','YYYY/MM/DD'),2,2);
 ...
 insert into event1(id,dateof,descriptionValue,invitation,name,organiser_id)
